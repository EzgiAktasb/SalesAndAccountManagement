...
public class MainMenuFrame extends JFrame {
    ...
    public MainMenuFrame() {
        ...
        JLabel lblNewLabel = new JLabel(
                "1) To manage products and access the related operations, press \"Manage Products\"");
        lblNewLabel.setBounds(22, 52, 497, 29);
        contentPane.add(lblNewLabel);

        JLabel lblNewLabel_1 = new JLabel(
                "2) To manage accounts and access the related operations, press \"Manage Accounts\"");
        lblNewLabel_1.setBounds(22, 79, 424, 14);
        contentPane.add(lblNewLabel_1);

        JLabel lblNewLabel_2 = new JLabel(
                "3) To view the transactions, press \"View Transactions\"");
